...
public class Constants {
    ...
    public static final String MONEY_HASH = "http://potchei.kangleigeeks.in/private/Payment/PayUMoneyHash.php";
    ...
    public static final String MERCHANT_KEY = "z7CuWVMr";
    public static final String MERCHANT_ID = "6835865";
    ...
    public interface ServerUrl {
        ...
        String MAIN_URL = "http://potchei.kangleigeeks.in/public/";
